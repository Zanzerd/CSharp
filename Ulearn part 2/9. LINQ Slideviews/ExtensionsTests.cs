...
namespace linq_slideviews
{
    ...
    public class ExtensionsTests
    {
        ...
        [Test]
        public void BigramsIsLazy()
        {
            var actual = new[] { 1, 2, 3, 4, 5, 6, 7, 8, 9 }.Bigrams().Take(4);
            Assert.That(actual, Is.EqualTo(new[] { Tuple.Create(1, 2), Tuple.Create(2, 3), Tuple.Create(3, 4),
            Tuple.Create(4, 5)})) ;
        }
    }
}