...
namespace Inheritance.DataStructure
{
    ...
    public class Category_should
    {
        ...
        {
            var newCat = new Category(null, MessageType.Incoming, MessageTopic.Error);
            var newCat2 = new Category(null, MessageType.Incoming, MessageTopic.Error);
            Assert.True(newCat.CompareTo(newCat2) == 0);
        }
